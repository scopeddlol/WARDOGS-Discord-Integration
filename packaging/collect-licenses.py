...
shutil.copytree(root / 'docs' / 'licenses', out / 'upstream', dirs_exist_ok=True)
...
Image.open(root / 'tray_icon.png').save(root / 'packaging' / 'app.ico', sizes=[(16, 16), (32, 32), (48, 48), (256, 256)])
