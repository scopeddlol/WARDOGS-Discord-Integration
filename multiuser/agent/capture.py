...
class CaptureDialog(QDialog):
    def __init__(self, settings, parent=None):
        ...
        label = QLabel("Select a box, then drag over the matching game text or icon.\n"
                       "Capture reads only WARDOGS. The delay gives you time to open its pause menu. Screenshots stay on this PC.")
    ...
    def countdown(self):
        ...
        self.hint.setText("Open the pause menu for server details. Capturing in 5 seconds…")
